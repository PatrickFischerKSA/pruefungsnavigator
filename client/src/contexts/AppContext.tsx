...
export const FAECHER: Fach[] = [
  ...
  },
  {
    ...
    label: "Französisch",
    emoji: "🇫🇷",
    themen: ["Grammaire", "Vocabulaire", "Compréhension de texte", "Expression écrite", "Littérature"],
    pruefungsformat: "Compréhension écrite, expression écrite et exercices de grammaire",
    promptHinweis: "Réponds en français. Utilise un vocabulaire académique et fournis des exemples grammaticaux.",
  },
  {
    id: "englisch",
    label: "Englisch",
    emoji: "🇬🇧",
    themen: ["Grammar", "Vocabulary", "Text Analysis", "Writing", "Literature"],
    pruefungsformat: "Reading comprehension, essay writing and grammar exercises",
    promptHinweis: "Use academic vocabulary. Provide examples for grammar rules. Answer in English.",
  },
  {
    id: "mathematik",
    label: "Mathematik",
  ...
  },
  {
    ...
    label: "Chemie",
    emoji: "⚗️",
    themen: ["Atombau", "Chemische Bindungen", "Reaktionsgleichungen", "Organische Chemie", "Säuren & Basen"],
    pruefungsformat: "Rechenaufgaben, Reaktionsgleichungen und Erklärungsaufgaben",
    promptHinweis: "Zeige Reaktionsgleichungen vollständig und ausgeglichen. Erkläre Mechanismen Schritt für Schritt.",
  },
  {
    id: "physik",
    label: "Physik",
    emoji: "⚡",
    themen: ["Mechanik", "Elektrizität", "Optik", "Thermodynamik", "Wellen"],
    pruefungsformat: "Rechenaufgaben mit Formeln, Diagrammanalyse und Erklärungsaufgaben",
    promptHinweis: "Nenne immer die verwendeten Formeln und Einheiten. Erkläre physikalische Phänomene mit Alltagsbeispielen.",
  },
  {
    id: "geschichte",
    label: "Geschichte",
  ...
  },
  {
    ...
    label: "Geografie",
    emoji: "🌍",
    themen: ["Physische Geografie", "Humangeografie", "Klimazonen", "Wirtschaftsgeografie", "Kartenkunde"],
    pruefungsformat: "Kartenanalyse, Diagramminterpretation und Erklärungsaufgaben",
    promptHinweis: "Beziehe dich auf aktuelle Beispiele und erkläre räumliche Zusammenhänge.",
  },
  {
    id: "psychpaed",
    label: "Psychologie/Pädagogik",
    emoji: "🧠",
    themen: ["Lerntheorien", "Entwicklungspsychologie", "Sozialpsychologie", "Unterrichtsmethoden", "Motivation"],
    pruefungsformat: "Fallstudien, Theorienvergleich und Anwendungsaufgaben aus dem Schulalltag",
    promptHinweis: "Verknüpfe Theorien mit konkreten Fallbeispielen. Beziehe dich auf den Lehrberuf und pädagogische Situationen.",
  },
  {
    id: "philosophie",
    label: "Philosophie",
    emoji: "🦉",
    themen: ["Erkenntnistheorie", "Ethik", "Logik", "Metaphysik", "Politische Philosophie"],
    pruefungsformat: "Erörterung, Textanalyse und argumentative Kurzessays",
    promptHinweis: "Argumentiere strukturiert mit These, Antithese und Synthese. Beziehe dich auf philosophische Positionen.",
  },
  {
    id: "medienkommunikation",
    label: "Medien/Kommunikation",
    emoji: "📡",
    themen: ["Medienanalyse", "Kommunikationsmodelle", "Medienwirkung", "Digitale Medien", "Rhetorik"],
    pruefungsformat: "Medienanalyse, Fallstudien und Kommunikationsanalyse",
    promptHinweis: "Analysiere Medieninhalte kritisch. Beziehe dich auf Kommunikationsmodelle (z.B. Schulz von Thun, Shannon-Weaver).",
  },
];
