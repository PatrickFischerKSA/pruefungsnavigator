...
import { Upload, Brain, FlaskConical, BookOpen, Sparkles, ArrowRight, Users, Clock, Target, Zap } from "lucide-react";
      ...
      <div className="min-h-screen">
        ...
        <div className="container py-12">
          <div className="mb-8">
            ...
            <p className="text-slate-400 text-sm">Folge dem Navigator Schritt für Schritt – oder springe direkt zur Phase, die du brauchst.</p>
          </div>
